...
library("png") 
img_r <- readPNG("~/probability-and-inference-portfolio-Ganiyu-Mubarak/04-home-field-advantage/atlanta-braves-logo-font.png", native = TRUE)
```
...
The difference in probabilities is `r abs(n_ha-ha)`
