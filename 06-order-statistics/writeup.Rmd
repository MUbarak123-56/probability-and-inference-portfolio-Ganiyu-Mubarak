...
n <- data.frame(b = b)
n <- n %>%
  mutate(b = if_else(b < -0.15 & b >= min(b), -0.18, 
         if_else(b < -0.1 & b >= -0.15, -0.13,
         if_else(b < -0.05 & b >= -0.1, -0.075,
         if_else(b < 0 & b >= -0.05,-0.025,
         if_else(b >= 0 & b < 0.05,0.025,
         if_else(b >= 0.05 & b < 0.1,0.075,
         if_else(b >= 0.1 & b < 0.15,0.13,
         if_else(b >= 0.15 & b <= max(b), 0.18)))))))))
n
hist(b,
     freq = FALSE,
     prob = TRUE,
