...
library("png") 
img_r <- readPNG("~/probability-and-inference-portfolio-Ganiyu-Mubarak/03-discrete-probability-calculations/atlanta-braves-logo-font.png", native = TRUE)
```
...
```{r}
p_055 <- dnbinom(3,4,0.55) 
p_045 <- dnbinom(3,4,0.45)
p_055_win7 <- p_055/(p_055+p_045)# P(P(B)=0.55 | Braves win World Series in 7 games)
p_055_win7
```
...
W stands for The braves winning the World Series in 7 games. We need to figure out `P(P(B) = 0.55)*P(W|P(B)=0.55))` and `P(W)`

$$P(W)=P(P(B)=0.55|W)∗P(W))+P(P(B)=0.45|W)∗P(W))$$
$$P(P(B) = 0.55)*P(W|P(B)=0.55))  = {6 \choose 3}*(0.55)^4*(0.45)^3 = 0.1667$$
$$P(P(B) = 0.55)*P(W|P(B)=0.55))  = {6 \choose 3}*(0.45)^4*(0.55)^3 = 0.1365$$

$$P(W) = 0.1667 + 0.1365 = 0.3032$$
Therefore,
$$P(P(B)=0.55 | W) = 0.1667 \div 0.3032 = 0.549 == 0.55 $$

The `P(B)=0.55` given that the braves win in 7 games is `r p_055_win7`
