...
As it can be observed the shape above is estimated to be `r coef(fit)[1]` and the scale is also estimated as `r coef(fit)[2]`.
...
Here, the MOM estimated the values of shape to be `r mom_shape` and scale to be `r mom_scale`. Here is how it is calculated.
...
Below are the results of the outcomes of using MLE and MOM to model normal, gamma and weibull distributions of Glycohemoglobin in order to see which one of them works best.
