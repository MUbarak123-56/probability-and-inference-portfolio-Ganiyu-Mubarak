...
The Martingale's strategy was an amazing strategy to explore from a statistical standpoint because of it deploys statistical techniques in the real world. Martingale's theory about his strategy being error-proof was proven wrong because it was proven to only work **half of the time**. Any one who wants to play a game of roulette using Martingale's strategy should take note of this information next time before playing so they are not too overconfident in the ability of the strategy to win. An improvement for this strategy will be to account for what happens when the green pocket is selected on the roulette wheel. Should the player get half of his wager back or should he get nothing? 
